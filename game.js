...
(function () {
    ...
    const LOCALIZATION_MATRIX = {
        ...
        he: {
            nav_shop: "חנות", nav_skins: "סקינים", nav_wheel: "גלגל המזל", nav_leaderboard: "מובילים", nav_profile: "פרופיל", nav_settings: "הגדרות",
            hud_score: "ניקוד", hud_size: "גודל", hud_level: "רמה", hud_best: "שיא",
            lbl_wheel_spin: "סובב גלגל", lbl_wheel_cost: "עלות: 50 מטבעות", lbl_claim_daily: "קבל פרס יומי", lbl_next_reward: "הפרס הבא בעוד:",
            lbl_purchase: "רכוש", lbl_equip: "צייד", lbl_equipped: "מצויד", lbl_owned: "בבעלותך"
        },
        es: {
    ...
    function localizeDomTree(langCode) {
        ...
        const playButtonLabels = { en: "PLAY", he: "משחק", es: "JUGAR", ja: "???", zh: "????", ko: "???", fr: "JOUER", de: "SPIELEN", ru: "??????", pt: "JOGAR", it: "GIOCA", tr: "OYNAT", hi: "?????", ar: "????" };
